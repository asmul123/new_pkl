        ...
        <div class="row">
            <div class="col-xl">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form method="POST" action="<?= base_url('peserta/jurnaladd') ?>">
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <select name="ploating_id" class="form-control">
                                        ...
                                        ?>
                                            <option value="<?= $p->ploating_id ?>"><?= $p->name ?></option>
                                        <?php } ?>
                                    </select>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="date" name="jurnal_date" class="form-control" value="<?= date('Y-m-d') ?>" />
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="text" name="division" class="form-control" placeholder="Masukan Unit Kerja" />
